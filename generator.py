...
'''
For deliverable 1 we are not analyzing the distribution for the service time
therefore for now it will just return a default value.
Will be implemented in deliverable 2.
'''
